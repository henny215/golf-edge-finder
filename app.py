...
.block-container { padding-top: 4.5rem; max-width: 1140px; }
...
body {{ background:#0F0F0F; color:#b0b0b0; font-family:'IBM Plex Mono',monospace; font-size:13px; -webkit-font-smoothing:antialiased; }}
